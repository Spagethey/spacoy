...
print("""\033[94m
 ...
 /_/   \_\_|   \__, |\__,_|_|
    ...
    | UDP ATTACKED YALZ 2TZK |

        |Methods = UDP OR TCP|

""")

ip = str(input("\033[94m Ip Targetnya \033[1;31;40m  ====> : "))

port = int(input(" \033[94mPort Targetnya \033[1;31;40m====> : "))
...
def run():
	...
	while True:
		...
		try:
			...
			print(" 0xF1 Spagethey / Aryalz %s"%(ip,port))
...
def tcp():
	...
	while True:
		...
		try:
			...
			print("\033[1;31;40m 0xF1 Spaget %s Kontol %s"%(ip,port))
